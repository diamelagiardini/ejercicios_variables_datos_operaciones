alert('Hola! Bienvenide a la Heledaria Imaginaria "Gustitos JS 🍦". Te voy a pedir tres gustos de helado en el siguiente paso.')

let gusto1 = prompt("Ingresa el primer gusto");
